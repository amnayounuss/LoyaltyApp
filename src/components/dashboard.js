              ...
              <CardBody className="bg-warning">
                <Media className="static-top-widget row">
                  ...
                  <Media body className="col-8">
                    ...
                    <h3 className="mb-0">
                      {Currency.sr} <CountUp className="counter" end={6659} />
              ...
              <CardBody className="bg-secondary ">
                <Media className="static-top-widget row">
                  ...
                  <Media body className="col-8">
                    ...
                    <h3 className="mb-0">
                      {Currency.sr} <CountUp className="counter" end={9856} />
                      <small> This Month</small>
                    </h3>
                  </Media>
                </Media>
              ...
              <CardBody className="bg-primary">
                <Media className="static-top-widget row">
                  ...
                  <Media body className="col-8">
                    ...
                    <h3 className="mb-0">
                      {Currency.sr} <CountUp className="counter" end={8933} />
                      <small> This Month</small>
                    </h3>
                  </Media>
                </Media>
              ...
              <CardBody className="bg-danger ">
                <Media className="static-top-widget row">
                  ...
                  <Media body className="col-8">
                    ...
                    <h3 className="mb-0">
                      {Currency.sr} <CountUp className="counter" end={45631} />
                      <small> This Month</small>
                    </h3>
                  </Media>
                </Media>
                  ...
                  <Table borderless>
                    ...
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td className="digits">{Currency.sr}6523</td>
                      </tr>
                      <tr>
                        <td>5</td>
                        <td className="digits">{Currency.sr}50.00</td>
                      ...
                      <div className="order-graph-bottom">
                        <Media>
                          ...
                          <Media body>
                            <h6 className="mb-0">
                              Saint Lucia{" "}
                              <span className="pull-right">{Currency.sr}157</span>
                            </h6>
                          </Media>
                        </Media>
                        <Media>
                          ...
                          <Media body>
                            <h6 className="mb-0">
                              Kenya <span className="pull-right">{Currency.sr}347</span>
                            </h6>
                          </Media>
                        </Media>
                        <Media>
                          ...
                          <Media body>
                            <h6 className="mb-0">
                              Liberia<span className="pull-right">{Currency.sr}468</span>
                            </h6>
                          </Media>
                        </Media>
                        <Media>
                          ...
                          <Media body>
                            <h6 className="mb-0">
                              Christmas Island
                              <span className="pull-right">{Currency.sr}742</span>
                            </h6>
                          </Media>
                        </Media>
                        <Media>
                          ...
                          <Media body>
                            <h6 className="mb-0">
                              Saint Helena{" "}
                              <span className="pull-right">{Currency.sr}647</span>
                            </h6>
                          </Media>
                        </Media>
                      </div>
